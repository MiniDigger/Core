...
public class BedFeature extends CoreFeature {
	...
	public void onBedDestory(final BlockBreakEvent e) {
		...
		if (e.getBlock().getType() == Material.BED_BLOCK) {
			...
			// + ": " +
			// bed.toString());
			if (e.getBlock().getLocation().equals(bed) || e.getBlock().getLocation().add(1, 0, 0).equals(bed) || e.getBlock().getLocation().add(-1, 0, 0).equals(bed) || e.getBlock().getLocation().add(0, 0, 1).equals(bed)
					|| e.getBlock().getLocation().add(0, 0, -1).equals(bed)) {
