...
public class LangKeyType {
	...
	public static class Cmd {
		...
		public static final LangKeyType	EXCEPTION_TAB	= new LangKeyType("exception_tab", type, "Unhandled exception during tab completion for command `%0%` in plugin `%1%`");
	...
	public static class Lang {
		...
		public static final LangKeyType	WARNING_NOT_TRANSLATED	= new LangKeyType("warning_not_translated", type, "Could not find lang key `%0%` in file `%1%`: Using default value");
