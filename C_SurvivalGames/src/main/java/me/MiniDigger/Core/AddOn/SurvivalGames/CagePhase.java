...
public class CagePhase extends CoreTimedPhase {
	...
	public void init() {
		...
		addFeature(new MobFeature(this, Core.getCore().getEntityUtil().getAll(Type.OTHER, Type.CART, Type.PROJECTILE, Type.UTILITY, Type.ANGRY, Type.PASSIV, Type.FRIENDLY)));
