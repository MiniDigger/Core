...
public class SGAddOn extends CoreAddOn {
	
	@Override
	public void enable() {
		GameType.SG.setClass(SGGame.class);
	...
	@Command(name = "sg", permission = "sg", usage = "", consol = true, description = "Initiiert ein SG Game", max = 0, sync = true)
	public void getthedrop(final CommandArgs args) {
		final SGGame game = new SGGame();
		game.init();
