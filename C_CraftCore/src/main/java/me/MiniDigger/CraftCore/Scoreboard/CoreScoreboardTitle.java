...
public class CoreScoreboardTitle implements ScoreboardTitle {
	...
	@SuppressWarnings("unused") private boolean	scrolling;
	@SuppressWarnings("unused") private String	orig;
	
	public CoreScoreboardTitle(final String title, final DisplaySlot slot) {
		this.title = title;
		this.slot = slot;
