...
public class KitCommands {
	...
	public void kit(final CommandArgs args) {
		Prefix.KIT.getPrefix().then("Klicke hier ").color(ChatColor.YELLOW).suggest("/kit create ").then("um ein neues Kit zu erzeugen").color(ChatColor.GOLD).send(args.getSender());
		Prefix.KIT.getPrefix().then("Klicke hier ").color(ChatColor.YELLOW).suggest("/kit give ").then("um ein Kit zu vergeben").color(ChatColor.GOLD).send(args.getSender());
		Prefix.KIT.getPrefix().then("Klicke hier ").color(ChatColor.YELLOW).suggest("/kit modify ").then("um ein Kit zu modifizieren").color(ChatColor.GOLD).send(args.getSender());
		Prefix.KIT.getPrefix().then("Klicke hier ").color(ChatColor.YELLOW).suggest("/kit delete ").then("um ein Kit zu löschen").color(ChatColor.GOLD).send(args.getSender());
	}
