...
public class EffectsCommands {
	...
	public static final String[] effects = new String[] { "animatedball", "arc", "atom", "bigbang", "bleed", "circle", "cloud", "coloredimage", "cone", "cube", "cylinder", "discoball", "dna", "donut", "dragon", "earth",
			"explode", "flame", "fountain", "grid", "heart", "helix", "hill", "icon", "image", "jump", "line", "love", "music", "shield", "skyrocket", "smoke", "sphere", "star", "text", "tornado", "trace", "turn",
			"vortex", "warp", "wave" };
	...
	public void coloredimage(final CommandArgs args) {
		try {
			...
			args.getPlayer().sendMessage(ChatColor.RED + "The image was not loaded! Make sure you have " + "an image called gifimage.gif in your /plugins/EffectLibTest/ folder!");
			e.printStackTrace();
		}
	}
	...
	public void image(final CommandArgs args) {
		try {
			...
			args.getPlayer().sendMessage(ChatColor.RED + "The image was not loaded! Make sure you have " + "an image called image.png in your /plugins/EffectLibTest/ folder!");
			e2.printStackTrace();
		}
	}
