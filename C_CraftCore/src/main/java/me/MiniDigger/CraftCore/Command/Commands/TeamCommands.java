...
public class TeamCommands {
	...
	public void team(final CommandArgs args) {
		Prefix.API.getPrefix().then("Klicke hier ").color(ChatColor.YELLOW).command("/team join ").then("um einem Team beizutreten").color(ChatColor.GOLD).send(args.getSender());
		Prefix.API.getPrefix().then("Klicke hier ").color(ChatColor.YELLOW).suggest("/team list ").then("um alle Teams anzuzeigen").color(ChatColor.GOLD).send(args.getSender());
	}
	...
	public void list(final CommandArgs args) {
		...
		;
		for (final Team team : f.getTeams()) {
			Prefix.API.getPrefix().then(team.getName() + ": ").color(team.getColor()).command("/team join " + team.getName()).then(team.getPlayers().size() + " Spieler").color(ChatColor.AQUA).send(args.getSender());
			;
		}
