...
public class CoreServerPing implements ServerPing {
	...
	private void close(final Socket socket, final OutputStream outputStream, final DataOutputStream dataOutputStream, final InputStream inputStream, final InputStreamReader inputStreamReader) {
		try {
			dataOutputStream.close();
			inputStreamReader.close();
			outputStream.close();
