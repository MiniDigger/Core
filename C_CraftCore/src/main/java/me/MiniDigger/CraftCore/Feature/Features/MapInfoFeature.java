...
public class MapInfoFeature extends CoreFeature {
	...
	private void modBoard(final Scoreboard b) {
		...
		i++;
		b.addLine(new CoreScoreboardLine(i, ChatColor.AQUA + ChatChars.Misc.bullet + " " + Core.getCore().getMapHandler().getAuthor(m.getMap().getName()), DisplaySlot.SIDEBAR));
		i++;
		b.addLine(new CoreScoreboardLine(i, ChatColor.GOLD + "Author: ", DisplaySlot.SIDEBAR));
		i++;
		b.addLine(new CoreScoreboardLine(i, ChatColor.AQUA + ChatChars.Misc.bullet + " " + Core.getCore().getMapHandler().getName(m.getMap().getName()), DisplaySlot.SIDEBAR));
		i++;
