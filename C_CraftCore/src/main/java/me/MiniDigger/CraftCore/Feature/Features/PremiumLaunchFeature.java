...
public class PremiumLaunchFeature extends CoreFeature {
	...
	public PremiumLaunchFeature(Phase phase) {
		super(phase);
	}
	
	@Override
	public FeatureType getType() {
		return FeatureType.PREMIUMLAUNCH;
	}
	...
	@Override
	public void start() {
		loc1 = new Location(Bukkit.getWorld("Spawn"), -869, 34, -700, 180, 0);
		loc2 = new Location(Bukkit.getWorld("Spawn"), -854, 77, -674, 90, 0);
	}
