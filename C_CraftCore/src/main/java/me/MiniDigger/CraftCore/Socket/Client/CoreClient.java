...
public class CoreClient implements Client {
	...
	public boolean createTable() {
		final SQLQuery q = new CoreSQLQuery("CREATE TABLE IF NOT EXISTS `external_users` (`name` varchar(40) NOT NULL, `password` varchar(40) NOT NULL, PRIMARY KEY (`name`), UNIQUE KEY `name` (`name`))");
		try {
