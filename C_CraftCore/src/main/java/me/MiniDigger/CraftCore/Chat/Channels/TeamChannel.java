...
public class TeamChannel extends CoreChatChannel {
	
	public TeamChannel(final String name, final ChatColor color, final String hearPerm, final String speakPerm, final FancyMessage prefix) {
