...
public class CoreNametagHandler implements NametagHandler {
	...
	private Map<String, NametagEntity>	entities	= new HashMap<>();
	...
	private  void addCustomEntity(Class<? extends net.minecraft.server.v1_7_R3.Entity> entityClass, String name, int id) {
		try {
	...
	private  void initPlayer(Player player) {
		...
		if (!entities.containsKey(playerName)) {
			NametagEntity entity = new CoreNametagEntity(player);
