...
/**
 * Represents a node in the language model. Contains the symbol at this
 * position, a count of the number of times this context has occurred (usage), a
 * list/map of children, and a total count of the usages of all its children
 * (count).
 *
 * @author Trejkaz
 * @see TrieNodeMap
...
public class TrieNode {
	 ...
	 * @param createIfNull
	 *            if true, grows the tree if the child node did not exist.
	 * @return the trie node for this symbol, newly created if necessary.
	 */
	public TrieNode getChild(final Symbol symbol, final boolean createIfNull) {
