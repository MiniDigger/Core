...
public class KKAddOn extends CoreAddOn {
	...
	@Override
	public void enable() {
		GameType.KK.setClass(KKGame.class);
	...
	@Command(name = "kk", permission = "kk", usage = "", consol = true, description = "Initiiert ein KK Game", max = 0, sync = true)
	public void getthedrop(final CommandArgs args) {
		final KKGame game = new KKGame();
		game.init();
