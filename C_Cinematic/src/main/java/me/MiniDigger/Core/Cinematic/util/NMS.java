...
public class NMS {
	...
	public static net.minecraft.server.v1_8_R3.ItemStack getNMSItemStack(final ItemStack itemstack) {
		...
		final CraftItemStack cbStack = ((CraftItemStack) itemstack);
		try {
	 ...
	 * @param movZ
	 */
	public static void relMoveEntity(final LivingEntity entity, final double movX, final double movY, final double movZ) {
	...
	public static void makeIdiot(final org.bukkit.entity.LivingEntity e) {
		...
		/*
		 * try { Field gsa =
		 * net.minecraft.server.v1_7_R3.PathfinderGoalSelector.
